...
;(function ($, window, undefined)
{
    ...
    */
    ...
    Grid.defaults = {
         ...
         * @since 1.1.0
         **/
        responseHandler: function (response) { return {rows: response.data, current: parseInt(response.page), total: response.total, rowCount: response.per_page, totalPages: response.total_pages}; },
        ...
        formatters: {
            ...
            "nome": function (column, row) {
                return row.first_name.charAt(0).toUpperCase() + row.first_name.slice(1) + " " + row.last_name.charAt(0).toUpperCase() + ".";
            }
        },
        ...
        labels: {
            all: "Todos",
            infos: "Exibindo registro {{ctx.start}} à {{ctx.end}} de {{ctx.total}}",
            loading: "Carregando...",
